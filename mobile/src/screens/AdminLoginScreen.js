    ...
    <View style={styles.container}>
      <View style={styles.card}>
        ...
        <View style={styles.top}>
          <Text style={styles.titulo}>Acceso admin</Text>
          <Text style={styles.subtitulo}>Marcecos — Personal autorizado</Text>
        </View>
        ...
        <TouchableOpacity
          style={[styles.btnIngresar, cargando && styles.btnDeshabilitado]}
          onPress={handleLogin}
          disabled={cargando}
        >
...
const styles = StyleSheet.create({
  ...
  btnIngresarText: { color: '#fff', fontWeight: '700', fontSize: 12, letterSpacing: 3 },
})